    ...
    public static Website mergePermissionInfoForTopLevelOrigin(
        ...
        for (Set<Website> websiteSet : websiteSets) {
            for (Website other : websiteSet) {
                ...
                if (merged.getAutoplayPermission() == null &&
                        other.getAutoplayPermission() != null) {
                    if (other.getAutoplayException().getPattern().equalsIgnoreCase(origin))
                        merged.setAutoplayException(other.getAutoplayException());
                }
                if (merged.getBackgroundSyncPermission() == null &&
                        other.getBackgroundSyncPermission() != null) {
                    if (other.getBackgroundSyncException().getPattern().equalsIgnoreCase(origin))
