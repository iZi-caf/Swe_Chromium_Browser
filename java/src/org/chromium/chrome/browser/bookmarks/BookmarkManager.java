...
public class BookmarkManager implements BookmarkDelegate {
    ...
    public void addSearchViewStateListener(View.OnAttachStateChangeListener listener) {
        mViewSwitcher.addOnAttachStateChangeListener(listener);
        mDrawerListView.addOnAttachStateChangeListener(listener);
    }

    public void removeSearchViewStateListener(View.OnAttachStateChangeListener listener) {
        mViewSwitcher.removeOnAttachStateChangeListener(listener);
        mDrawerListView.removeOnAttachStateChangeListener(listener);
    }
}
