...
public abstract class FirstRunFlowSequencer  {
    ...
    void processFreEnvironment(boolean androidEduDevice, boolean hasChildAccount) {
        ...
        boolean showSafeBrowsing = !CommandLine.getInstance()
                .hasSwitch(ChromeSwitches.DISABLE_SAFE_BROWSING);
        freProperties.putBoolean(FirstRunActivity.SHOW_SAFE_BROWSING_PAGE, showSafeBrowsing);

        freProperties.putBoolean(FirstRunActivity.SHOW_SECURITY_MOBILE_UPDATE_PAGE, true);
