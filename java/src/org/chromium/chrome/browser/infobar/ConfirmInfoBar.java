...
public class ConfirmInfoBar extends InfoBar {
    ...
    protected void onButtonClickedInternal(boolean isPrimaryButton) {
        int action = isPrimaryButton ? ContentSetting.ALLOW.toInt() : ContentSetting.BLOCK.toInt();
    ...
    private static ConfirmInfoBar create(WindowAndroid windowAndroid, int enumeratedIconId,
            ...
            String buttonCancel, int[] contentSettings, boolean isIncognito) {
        ...
        if (!isIncognito) {
            for (int contentSetting: contentSettings) {
                if(contentSetting == ContentSettingsType.CONTENT_SETTINGS_TYPE_MEDIASTREAM_CAMERA
                    || contentSetting == ContentSettingsType.CONTENT_SETTINGS_TYPE_MEDIASTREAM_MIC
                    || contentSetting == ContentSettingsType.CONTENT_SETTINGS_TYPE_GEOLOCATION) {
